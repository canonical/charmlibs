...
def _post_action(
    ...
    try:
        ...
        # NOTE: naming the snap itself (services=None) for a snap that isn't installed answers
        ...
        # raises NotInstalledError, as it does elsewhere in the library, leaving AppNotFoundError
