...
from dummy_requirer.src.charm import DummyHostInfoRequirerCharm
...
class TestTemporalHostInfoRequirer:
    ...
    def context(self):
        self.ctx = testing.Context(
            charm_type=DummyHostInfoRequirerCharm,
            meta=METADATA,
        )
    ...
    def test_require(self):
        relation = testing.Relation(
            ...
            remote_app_name='temporal-host-info-interface-provider',
            remote_app_data={
        ...
        assert state_out.unit_status == testing.ActiveStatus(
            'Host: test-host.example.com, Port: 7233'
        )
