...
This namespace is for packages designed to be used by [Juju charms](https://canonical.com/juju/charms-architecture) to implement [relations](https://documentation.ubuntu.com/ops/latest/howto/manage-relations/), known as charm interface libraries. Read the [charmlibs documentation](https://canonical.com/juju/docs/charmlibs) for more information about charm libraries.
